        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          ...
          >
            ...
            <p className="text-sm text-gray-500 mb-6 border-b pb-2">
              Pengaju: <span className="font-semibold text-gray-700">{selectedIzin?.name}</span> ({selectedIzin?.role})
            </p>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  type="date"
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-[#A97458] focus:border-transparent outline-none transition"
                  onChange={(e) =>
              ...
              <div>
                <label className="text-sm font-medium text-gray-700 mb-1 block">Jam Mulai</label>
                <input
                  type="time"
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-[#A97458] focus:border-transparent outline-none transition"
                  onChange={(e) =>
              ...
              <div>
                <label className="text-sm font-medium text-gray-700 mb-1 block">Jam Selesai</label>
                <input
                  type="time"
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-[#A97458] focus:border-transparent outline-none transition"
                  onChange={(e) =>
