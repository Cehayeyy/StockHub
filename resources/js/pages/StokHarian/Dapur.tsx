  ...
  const submit = async (e: React.FormEvent) => {
    ...
    router.post(route(routeName), {
      ...
      onError: (errors) => {
        ...
        setWarningMessage(firstError as string || "Gagal menyimpan.");
      },
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-black text-red-700">Peringatan Sistem Dapur</p>
              ...
              <div>
                ...
                <p className="text-amber-700 text-xs mt-0.5 leading-relaxed">
                  {tab === "menu" && isAlreadySubmitted && !isPastCutoff
                    ? "Tab Menu terkunci karena data sudah berhasil disimpan. Anda masih bisa input di tab Mentah sampai jam 21:00."
            ...
            <div className="flex flex-col md:flex-row items-center gap-3 w-full md:w-auto">
              ...
              <div className="relative w-full md:w-auto">
                <input
                  ...
                  autoFocus
                  className="w-full md:w-64 bg-gray-50 border border-gray-200 rounded-full pl-4 pr-10 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#8B5E3C]"
                />
