...
export default function Bar() {
  ...
  const [formStokMasuk, setFormStokMasuk] = useState("");
...
const submitUpdate = () => {
  ...
  if (tab === "mentah") {
  payload.stok_masuk =
    formStokMasuk === "" ? 0 : Number(formStokMasuk);

  payload.stok_keluar =
    formPemakaian === "" ? 0 : Number(formPemakaian);
}
