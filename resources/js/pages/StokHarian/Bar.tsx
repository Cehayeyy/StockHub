                ...
                {items.data.length > 0 ? (
                  items.data.map((item, i) => (
                    <tr key={item.id} className="hover:bg-[#FFF9F0] transition">
                      ...
                      <td className="p-4 text-center">{item.stok_masuk}</td>
                      ...
                      {/* === KOLOM AKSI DIPERBARUI SESUAI TAMPILAN ITEM === */}
                  ...
                  <tr><td colSpan={9} className="p-8 text-center text-gray-400">Belum ada data stok.</td></tr>
                )}
              </tbody>
            </table>
          </div>
